...
class BrodenDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.directory = 'datasets/data/broden'
        self.resolution = resolution
        self.resdir = os.path.join(self.directory, 'broden%d_%d' %
        ...
        for label in self.label_info[1:]:
            num_cat = len(label['category'].keys())
...
#            for cat in categories:
                ...
                #     print(root_label)
                #     label['category'][cat] = self.category_map[cat][label['category'][cat]]
